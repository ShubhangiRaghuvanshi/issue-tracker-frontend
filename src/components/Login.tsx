        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-8 relative overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="relative space-y-6">
                ...
                <div className={`relative transition-all duration-300 ${
                  ...
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none z-10">
                    <div className={`transition-colors duration-200 ${
                      ...
                      {getFieldIcon(key as keyof LoginFormData)}
                    </div>
                  </div>
                  ...
                  <input
                    ...
                    placeholder={
                      key === 'email' ? 'Email Address' : 'Password'
                    }
                    required
            ...
            <button
              ...
              className={`w-full py-4 px-6 rounded-2xl font-semibold text-white transition-all duration-300 flex items-center justify-center space-x-2 group ${
                isSubmitting
